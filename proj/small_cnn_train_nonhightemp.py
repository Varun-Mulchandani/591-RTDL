...
if training_required:
    ...
    print('Finished Training')
    torch.save(encoder1_prune3, 'small_cnn_nonhightemp/prune1.pt')
else:
    encoder1_prune3 = torch.load('small_cnn_nonhightemp/prune1.pt')
...
if training_required:
    ...
    print('Finished Training')
    torch.save(encoder1_prune4, 'small_cnn_nonhightemp/prune2.pt')
else:
    encoder1_prune4 = torch.load('small_cnn_nonhightemp/prune2.pt')
...
if training_required:
    ...
    print('Finished Training')
    torch.save(encoder1_prune5, 'small_cnn_nonhightemp/prune3.pt')
else:
    encoder1_prune5 = torch.load('small_cnn_nonhightemp/prune3.pt')

training_required = False

if training_required:
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.SGD(encoder1_prune6.parameters(), lr=0.0001, momentum=0.9)
    for epoch in range(25):  # loop over the dataset multiple times
    ...
    print('Finished Training')
    torch.save(encoder1_prune6, 'small_cnn_nonhightemp/prune4.pt')
else:
    encoder1_prune6 = torch.load('small_cnn_nonhightemp/prune4.pt')
